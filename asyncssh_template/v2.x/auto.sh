...
echo "asyncssh Versions:" > $RESULT_FILE
...
for COMMIT in "${COMMITS[@]}"; do
    ...
    docker build --build-arg COMMIT=$COMMIT -t asyncssh-$COMMIT_LOWER .
    ...
    CONTAINER_ID=$(docker run --rm -d -p 2222:8022 asyncssh-$COMMIT_LOWER)
